    ...
    return  (
        <Background>
            <div className="flex flex-col items-center justify-center homepage-bg text-center -mb-[16px]" style={{height:"120vh"}}>
                ...
                <div className="flex flex-col justify-center items-center align w-[690px]">
                    ...
                    <div>
                        ...
                        <button 
                            className="w-[100%] border-4 border-[#A7751E] rounded-[20px] py-[10px] text-[#A7751E] text-[40px] flex items-center justify-center mt-10 register-button hover:bg-[#A7751E] hover:text-white transition-all duration-300"    
